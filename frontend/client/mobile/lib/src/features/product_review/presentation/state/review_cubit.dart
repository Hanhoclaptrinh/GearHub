...
class ReviewCubit extends Cubit<ReviewState> {
  ...
  Future<void> loadReviews(String productId, {int? rating, bool? hasImage}) async {
    emit(ReviewLoading());
  ...
  Future<void> createReview({
    ...
    required String productId, // chi de reload reviews sau khi gui
    required int rating,
    String? comment,
